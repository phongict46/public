...
- VPN: connect to private network cloud ClearSky DEV(Development).
- Host external: laptop devices DBIZ staff connect to server vm running on cloud ClearSky DEV.
